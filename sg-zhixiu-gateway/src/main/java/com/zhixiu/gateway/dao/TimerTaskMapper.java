package com.zhixiu.gateway.dao;
...
public interface TimerTaskMapper {
	...
	List<TimerTask> findPageByLabel(@Param("label") String label);
	 ...
	 * @return
	 */
	List<TimerTask> findPageByTaskName(@Param("taskName") String taskName);

	List<TimerTask> findPage();
}
