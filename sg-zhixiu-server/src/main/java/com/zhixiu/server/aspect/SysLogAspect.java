package com.zhixiu.server.aspect;
...
import com.zhixiu.server.model.SysLog;
import com.zhixiu.server.service.SysLogService;
import com.zhixiu.server.util.HttpUtils;
import com.zhixiu.server.util.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("execution(* com.zhixiu.server.service.*.*(..))")
