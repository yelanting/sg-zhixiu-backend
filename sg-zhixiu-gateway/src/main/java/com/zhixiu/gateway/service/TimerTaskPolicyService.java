 ...
 * @see :
 */
public interface TimerTaskPolicyService extends CurdService<TimerTaskPolicy> {
	/**
	 * 查询地址列表
	 * 
	 * @see :
	 ...
	 * @return
	 */
	// Page<TimerTaskPolicy> findTimerTaskPolicyByPage(Integer page, Integer
	// size);
	TimerTaskPolicy insertOrUpdate(TimerTaskPolicy timerTaskPolicy);
}
