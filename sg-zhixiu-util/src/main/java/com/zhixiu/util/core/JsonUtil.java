/**
 * Project Name: manager-platform-server File Name: JsonUtil.java Package Name:
 * com.administrator.platform.core.base.util Date: 2019年10月10日 上午10:14:02
...
public class JsonUtil {
     ...
     * @return
     */
    public static <T> T jsonToObject(Object srcObject, Class<T> clazz) {
        return jsonToObject(srcObject.toString(), clazz);
    }
